            ...
            <div class="topbar d-flex align-items-center">
                <nav class="navbar navbar-expand gap-3">
                    ...
                    <div class="position-relative search-bar d-lg-block d-none" data-bs-toggle="modal"
                        ...
                        <span
                            class="position-absolute top-50 search-show ms-3 translate-middle-y start-0 top-50 fs-5"  style="display:none"><i
                                        ...
                                        <div class="row gx-0 gy-2 row-cols-3 justify-content-center p-2">
                                            <div class="col">
                                                <a href="javascript:;">
                                                    <div class="app-box text-center">
                                                        <div class="app-icon">
                                                            <img src="<?= base_url('assets/images/app/slack.png') ?>"
                                                                width="30" alt="">
                                                        </div>
                                                        <div class="app-name">
                                            ...
                                            <div class="col">
                                                <a href="javascript:;">
                                                    <div class="app-box text-center">
                                                        <div class="app-icon">
                                                            <img src="<?= base_url('assets/images/app/behance.png') ?>"
                                                                width="30" alt="">
                                                        </div>
                                                        <div class="app-name">
                                            ...
                                            <div class="col">
                                                <a href="javascript:;">
                                                    <div class="app-box text-center">
                                                        <div class="app-icon">
                                                            <img src="<?= base_url('assets/images/app/google-drive.png') ?>"
                                                                width="30" alt="">
                                                        </div>
                                                        <div class="app-name">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <div class="header-notifications-list">
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center">
                                                <div class="notify bg-light-success text-success">
                                                    <img src="<?= base_url('assets/images/app/outlook.png') ?>"
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center">
                                                <div class="user-online">
                                                    <img src="<?= base_url('assets/images/avatars/avatar-4.png') ?>"
                                                        class="msg-avatar" alt="user avatar">
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center">
                                                <div class="notify bg-light-primary">
                                                    <img src="<?= base_url('assets/images/app/github.png') ?>"
                                                        width="25" alt="user avatar">
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center">
                                                <div class="user-online">
                                                    <img src="<?= base_url('assets/images/avatars/avatar-8.png') ?>"
                                                        class="msg-avatar" alt="user avatar">
                                                </div>
                                                <div class="flex-grow-1">
                                    ...
                                    <div class="header-message-list">
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="<?= base_url('assets/images/products/11.png') ?>"
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="<?= base_url('assets/images/products/02.png') ?>"
                                                            class="" alt="product image">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="<?= base_url('assets/images/products/03.png') ?>"
                                                            class="" alt="product image">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="<?= base_url('assets/images/products/04.png') ?>"
                                                            class="" alt="product image">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="<?= base_url('assets/images/products/05.png') ?>"
                                                            class="" alt="product image">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="<?= base_url('assets/images/products/06.png') ?>"
                                                            class="" alt="product image">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="<?= base_url('assets/images/products/07.png') ?>"
                                                            class="" alt="product image">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="<?= base_url('assets/images/products/08.png') ?>"
                                                            class="" alt="product image">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="position-relative">
                                                    <div class="cart-product rounded-circle bg-light">
                                                        <img src="<?= base_url('assets/images/products/09.png') ?>"
                                                            class="" alt="product image">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                    ...
                    <div class="user-box dropdown px-3">
                        <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret"
                            ...
                            <img src="<?= get_foto_karyawan(session('id_user')) ?>" class="user-img"
                                alt="user avatar">
                            <div class="user-info">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item d-flex align-items-center"
                                    href="<?= base_url('sibabad2/profil-user') ?>"><i
                                        class="bx bx-user fs-5"></i><span>Profil Saya</span></a>
                            </li>
                            <li>
                                <div class="dropdown-divider mb-0"></div>
                            </li>
                            <li><a class="dropdown-item d-flex align-items-center"
                                    href="<?= base_url('auth/logged_out') ?>"><i
            ...
            <nav class="navbar navbar-expand-lg align-items-center">
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav align-items-center flex-grow-1 justify-content-center">
                            <li class="nav-item ">
                                <a class="nav-link " href="<?= base_url('/sibabad2') ?>">
                                    <div class="parent-icon"><i class='bx bx-cart'></i>
                                    </div>
                                    <div class="menu-title d-flex align-items-center">Kasir</div>
                                    
                                </a>
                                
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link " href="<?= base_url('/sibabad2/refund2') ?>">
                                    <div class="parent-icon"><i class='bx bx-donate-heart'></i>
                                    </div>
                                    <div class="menu-title d-flex align-items-center">Retur Refund</div>
                                    
                                </a>
                                
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link " href="<?= base_url('/sibabad2/tukar') ?>">
                                    <div class="parent-icon"><i class='bx bx-transfer-alt'></i>
                                    </div>
                                    <div class="menu-title d-flex align-items-center">Retur Tukar</div>
