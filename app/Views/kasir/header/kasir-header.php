        ...
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="position-relative search-bar d-lg-block d-none" data-bs-toggle="modal"
                ...
                <span class="position-absolute top-50 search-show ms-3 translate-middle-y start-0 top-50 fs-5"
                    style="display:none"><i class='bx bx-search'></i></span>
            </div>
            ...
            <div class="user-box dropdown px-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item d-flex align-items-center"
                            href="<?= base_url('sibabad2/profil-user') ?>"><i class="bx bx-user fs-5"></i><span>Profil
                                Saya</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="<?= base_url('auth/logged_out') ?>"><i
