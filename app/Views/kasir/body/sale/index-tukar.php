            ...
            <div class="col-xl-6 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form class="mt-3" action="<?= base_url('sibabad2/tukar') ?>" method="post">
                            <div class="row mb-3">
...
$('#submitTukar').on('click', function () {
    ...
    $.ajax({
        url: '<?= base_url('sibabad2/tukar/saveData') ?>',
        type: 'post',
        dataType: 'json',
        data: formData,
        success: function (response) {
            if (response.status) {
                Swal.fire({
                    ...
                    window.open(`<?= base_url('sibabad2/tukar/cetakTransaksi/') ?>${response.invoice}`);
                    window.location.href = '<?= base_url('sibabad2/tukar') ?>';
                });
            } else {
