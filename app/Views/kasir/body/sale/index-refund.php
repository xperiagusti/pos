            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Retur Refund</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-xl-6 col-sm-12">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <h5 class="mb-4">Form Retur Refund</h5>
                        <form class="mt-3" action="<?= base_url('sibabad2/refund2') ?>" method="post">
                            <div class="row mb-3">
                        ...
                        <div class="row">
                            ...
                            <form id="refundForm">
                                <table class="table mb-0 table-borderless mt-3">
                                    <thead class="text-center">
                                        <tr>
                                            ...
                                            <th scope="col">Satuan & Jumlah Retur</th>
                                            <th scope="col">Disc Produk %</th>
                                    ...
                                    foreach ($transaksi as $data) : ?>
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" name="subtotal_item_retur[]"
                                                    placeholder="0" readonly></td>
                                        </tr>

                                        <?php endforeach; ?>
                                        <tr>
                                            <td class="col" colspan="7" rowspan="6"></td>
                                            <td class="col"><b>Sub Total Retur</b></td>
                                            <td class="col"><input type="text" class="form-control"
                                                    name="subtotal_retur" placeholder="0" readonly></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="col"><b>Total Akhir Beli</b></td>
                                            <td class="col"><?=rupiah(esc($transaksi[0]['total_akhir']));?></td>
                                        </tr>
                                        <tr>
                                            <td class="col"><b>Total Akhir Retur</b></td>
                                            <td class="col"><input type="text" class="form-control" name="total_retur"
                                                    placeholder="0" readonly></td>
                                        ...
                                        <!-- <tr>
                                            ...
                                            <td class="col"><input type="number" class="form-control" name="kembalian"
                                                    placeholder="0"></td>
                                        </tr> -->
                                    </tbody>
                                ...
                                <div class="d-flex justify-content-center mt-3">
                                    <button type="button" id="submitRefund" class="btn btn-primary" style="margin-left: 10px;">Simpan Data Refund</button>
                                </div>
...
function calculateSubtotal(i) {
    ...
    if (satuanLevel === 1) {
        if (qtySelect === 1) {
            ...
            level2_plus = qty;
            level3_plus =  qty * (level_3 / level_2 );
...
$('#submitRefund').on('click', function () {
    ...
    let formData = $('#refundForm').serializeArray();
    $.ajax({
        url: '<?= base_url('sibabad2/refund/saveData') ?>',
        type: 'post',
        dataType: 'json',
        data: formData,
        success: function (response) {
            if (response.status) {
                Swal.fire({
                    ...
                    window.open(`<?= base_url('sibabad2/refund/cetakTransaksi/') ?>${response.invoice}`);
                    window.location.href = '<?= base_url('sibabad2/refund2') ?>';
                });
            } else {
