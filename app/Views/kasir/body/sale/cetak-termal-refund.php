    ...
    <div class="container">
            ...
            <table class="table">
                <tr>
                    ...
                    <td class="tengah" colspan="2" rowspan="2"
                        style="font-size:20px;font-weight:bold;text-align:center;vertical-align:middle">Refund
                        Invoice
                        <hr>
                    </td>
                </tr>
                <tr>
                    <td class="kiri"><?=$refund[0]['pelanggan'];?></td>
                    <td class="kiri"><?= get_nama_perusahaan() ?></td>
                </tr>

                <tr>
                    <td class="kiri" rowspan="2" width="210px"><?= $refund[0]['address'];?></td>
                    <td class="kiri" rowspan="2" width="210px"><?= get_alamat() ?></td>
                    <td class="tengah">Invoice Date</td>
                    <td class="tengah">Invoice No</td>
                </tr>
                <tr>
                    <td class="tengah"><?=date("d F Y", strtotime(esc($refund[0]['tanggal'])))?></td>
                    <td class="tengah"><?=esc($refund[0]['invoice']);?></td>
                </tr>
        ...
        <div class="transaksi">
            <table class="table">
                ...
                <?php $i=1;foreach (esc($refund) as $data): ?>
                ...
                <tr>
                    ...
                    <td class="kanan"><?=rupiah(esc($refund[0]['total_harga']));?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="kanan"><b><?=rupiah(esc($refund[0]['total_akhir']));?></b></td>
                </tr>
                <tr>
                    <td class="kiri">Disetujui,<br>Date <?=date("m/d/Y", strtotime(esc($refund[0]['tanggal'])))?><br>Time <?=date("H:i:s", strtotime(esc($refund[0]['tanggal'])))?><br></td>
