        ...
        <div class="row">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form class="mt-3" action="<?= base_url('sibabad/coa/saveCoaData') ?>" method="post" onsubmit="return validateForm()">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" id="journalDate" class="form-control" name="journal_date">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="journal_name" id="journalName" cols="30" rows="2" placeholder="Masukkan keterangan transaksi. Contoh: Pembelian barang dari PT.XXX"></textarea>
                                    <?php if (session()->get('errors')) : ?>
                                        <?php $errors = session()->get('errors'); ?>
            ...
            <div class="col-xl-6 col-sm-12">
                <div class="card">
                    <div class="card-body p-4">
                        <div class="row">
                            <form action="<?= base_url('sibabad/journal/saveJournal') ?>" method="post">
                                <input type="hidden" name="journal_date" id="hiddenJournalDate">
...
<script>
    document.getElementById("inputTable").addEventListener("click", function() {
        ...
        if (account && (debit || credit)) {
            ...
            hiddenAccountInput.name = "jd_account[]"; // Use an array to store multiple values
            ...
            hiddenDebitInput.name = "jd_debit[]"; // Use an array to store multiple values
            ...
            hiddenCreditInput.name = "jd_credit[]"; // Use an array to store multiple values
