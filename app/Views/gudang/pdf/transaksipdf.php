...
<body>
    ...
    <main>
        ...
        <div>
            <h5>Tanggal : <?= $sevendays ?> s/d <?= $today ?> </h5>
        </div>
        <?php elseif ($filter == '3') : ?>
        <?php
        $today = date('Y-m-d');
        ...
        <div>
            <h5>Tanggal : <?= $thirtydays ?> s/d <?= $today ?> </h5>
        </div>
        <?php elseif ($filter == '4') : ?>
        <?php
        ...
        <div>
            <h5>Tanggal : <?= $firstDayOfMonth ?> s/d <?= $lastDayOfMonth ?> </h5>
        </div>
        <?php elseif ($filter == '5') : ?>
        <?php
        ...
        <div>
            <h5>Tanggal : <?= $firstDayOfLastMonth ?> s/d <?= $lastDayOfLastMonth ?> </h5>
        </div>
        <?php elseif ($filter == '6') : ?>
        <div style="text-align: center;">
            ...
            <thead>
                <tr>
                    <td align="left"><small>
                            ...
                            Total Penjualan : Rp. <?= rupiah($rincianPenjualan['penjualan']) ?>
                            </br>
                            Total Penjualan Tunai : Rp. <?= rupiah($rincianPenjualan['penjualan_tunai']) ?>
                            </br>
                            Total Penjualan Non Tunai : Rp. <?= rupiah($rincianPenjualan['penjualan_non_tunai']) ?>
                            </br>
                            Total Retur Refund : Rp. <?= rupiah($rincianPenjualan['retur']) ?>
                            </br>
                            Total Kas Masuk : Rp. <?= rupiah($rincianKas['kas_masuk']) ?>
                            </br>
                            Total Kas Keluar : Rp. <?= rupiah($rincianKas['kas_keluar']) ?>
                            </br>
