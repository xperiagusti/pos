<div class="wrapper">
    ...
    <div class="sidebar-wrapper" data-simplebar="true">
        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a href="<?= base_url('sibabad3/product/add-new') ?>">
            ...
            <li>
                ...
                <ul>
                    <li><a href="<?= base_url('/sibabad3/direct_order/index') ?>"><i class='bx bx-radio-circle'></i>Pembelian Langsung</a>
                    </li>
                    <li><a href="<?= base_url('/sibabad3/recieve_order/index') ?>"><i class='bx bx-radio-circle'></i>Penerimaan Barang</a>
                    </li>
                </ul>
            </li>
            <li>
                <a href="<?= base_url('sibabad3/stock-product/index') ?>">
            ...
            <li>
                <a href="<?= base_url('sibabad3/transaction-sale/index') ?>">
                    <div class="parent-icon"><i class='bx bx-receipt'></i>
                    </div>
                    <div class="menu-title">Rekap Penjualan</div>
                </a>
            </li> -->
        </ul>
        <!--end navigation-->
