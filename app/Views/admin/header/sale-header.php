                ...
                <nav class="navbar navbar-expand gap-3">
                    ...
                    <div class="user-box dropdown px-3">
                        <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret"
                            ...
                            <!-- <img src="<?= base_url('assets/images/avatars/avatar-2.png') ?>" class="user-img"
                                alt="user avatar"> -->
                            <div class="user-info">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item d-flex align-items-center"
                                    href="<?= base_url('sibabad/profil-user') ?>"><i
                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav align-items-center flex-grow-1">
                            <li class="nav-item ">
                                <a class="nav-link " href="<?= base_url('/sibabad') ?>">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link " href="<?= base_url('sibabad/sale/index') ?>">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link " href="<?= base_url('sibabad/refund2') ?>">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link " href="<?= base_url('sibabad/tukar') ?>">
