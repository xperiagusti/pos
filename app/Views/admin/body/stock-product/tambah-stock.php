        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-sm-12">
                <div class="card">
                    <div class="card-body p-4">
                        <div class="row">
                        <form action="<?= base_url('sibabad/stock-product/saveData') ?>" method="post">
                            ...
                            <table class="table mb-0 table-striped mt-3 receiveProduct">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="tg-0lax">Konversi Satuan</td>
                                        <td class="tg-0lax"><input type="text" name="level_1" class="form-control"
                                                id="level_1" value="1" readonly></td>
                                        <td class="tg-0lax"><input type="number" name="level_2" class="form-control"
                                                id="level_2" oninput="jumlah_stok_lvl2();harga_jual_lvl2();" placeholder="contoh: 10"></td>
                                        <td class="tg-0lax"><input type="number" name="level_3" class="form-control"
                                                id="level_3" oninput="jumlah_stok_lvl3();harga_jual_lvl3();" placeholder="contoh: 100"></td>
                                    </tr>
                                    <tr>
