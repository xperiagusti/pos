...
class StockProductController extends BaseController
{
    ...
    public function index()
    {
        ...
        // }
        return view('gudang/body/stock-product/index-stock', $data);
    }
    ...
    public function tambah()
    {
        ...
        return view('gudang/body/stock-product/tambah-stock', $data);
    }
    ...
    public function bukaBox($id)
    {
        ...
        return view('gudang/body/stock-product/bukabox-stock', $data);
    }
    ...
    public function tambahPcs()
    {
        ...
        if (!$validation->withRequest($this->request)->run()) {
            ...
            if ($cariStokUnit) {
                ...
                return redirect()->to('sibabad3/stock-product/index')->withInput()->with('success', 'Data Stok Produk berhasil diupdate.');
            } else {
                $dataSave = [
                    'id_user'        => $userId,
                ...
                $this->stockModel->where('id_s_product', $id_s_product)->set('s_stock', 's_stock - ' . $jumlah_box_buka, false)->update();
                return redirect()->to('sibabad3/stock-product/index')->withInput()->with('success', 'Data Stok Produk berhasil disimpan.');
            }
    ...
    public function editProduct($id)
    {
        ...
        //     return redirect()->to(base_url('auth/logged_out'));
        // }
        return view('gudang/body/stock-product/edit-stock', $data);
    }
    ...
    public function editData($id)
    {
        ...
        if (!$validation->withRequest($this->request)->run()) {
            ...
            if ($existingData) {
                ...
                return redirect()->to('sibabad3/stock-product/index');
            }
        }
    }
