...
class RecieveOrderController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('gudang/body/recieve-order/index-ro', $data);
    }
    ...
    public function saveData($id)
    {
        ...
        if (!$validation->withRequest($this->request)->run()) {
            ...
            if($dStatus == '1')
            {
                ...
                return redirect()->to('sibabad3/recieve_order/index')->withInput()->with('success', 'Data Penerimaan Barang berhasil ditambahkan.');
            }
            else
            {
                return redirect()->to('sibabad3/recieve_order/index')->withInput()->with('error-delete', 'Data Penerimaan Barang belum ditambahkan.');
            }
    ...
    public function updateData($id)
    {
        ...
        else 
        {
            ...
            return redirect()->to('sibabad3/recieve_order/index')->withInput()->with('success', 'Data Penerimaan Barang berhasil diperbarui.');
        }
    }
    ...
    public function tambahRO($id)
    {
        ...
        return view('gudang/body/recieve-order/tambah-ro', $data);
    }
    ...
    public function detailRO($id)
    {
        ...
        return view('gudang/body/recieve-order/detail-ro', $data);
    }
    ...
    public function editRO($id)
    {
        ...
        return view('gudang/body/recieve-order/edit-ro', $data);
    }
