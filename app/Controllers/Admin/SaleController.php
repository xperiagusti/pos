...
class SaleController extends BaseController {
    ...
    public function index() {
        ...
        $date['waktu_end']   = $this->request->getVar('waktu_end');
            ...
            'kas_masuk' => $this->kasModel->listKasMasuk(),
            'kas_keluar' => $this->kasModel->listKasKeluar(),
            'stock' => $this->stockModel->daftar_stock(),
            'transaksi' => $this->saleModel->transaksiPenjualan($date),
            'transaksi_harian' => json_encode($this->saleModel->transaksiHarian($filter))
        ];
        ...
        return view('admin/body/sale/index-sale', $data);
    }

    public function transaksi_harian()
    {
        $filter = $this->request->getGet('filter');
        $data = $this->saleModel->transaksiHarian($filter);
    ...
    public function detailTransaksi($id) {
        ...
        return view('admin/body/sale/sale-detail', $data);
    }
