...
class UserController extends BaseController
{
    ...
    public function saveData()
    {
        ...
        if (!$validation->withRequest($this->request)->run()) {
            ...
            // Jika peran adalah 'Kasir' atau 'Gudang', tambahkan data ke tabel karyawan
            if ($role === 'Kasir' || $role === 'Gudang') {
                $karyawanData = [
    ...
    public function editData($id)
    {
        ...
        // Cek apakah password harus diubah
        $newPassword = trim($this->request->getVar('password'));
        if ($newPassword !== '') {
        ...
        if ($role === 'Kasir' || $role === 'Gudang') {
            ...
            $existingData = $this->karyawanModel->where('id_user', $id)->first();

            if ($existingData) {
                $this->karyawanModel->where('id_user', $id)->set($karyawanData)->update();
            } else {
                $this->karyawanModel->insert($karyawanData);
            }
        } else {
