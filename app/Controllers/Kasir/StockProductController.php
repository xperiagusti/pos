...
class StockProductController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('kasir/body/stock-product/index-stock', $data);
    }
    ...
    public function tambah()
    {
        ...
        return view('kasir/body/stock-product/tambah-stock', $data);
    }
    ...
    public function bukaBox($id)
    {
        ...
        return view('kasir/body/stock-product/bukabox-stock', $data);
    }
    ...
    public function editProduct($id)
    {
        ...
        $data['prod'] = $this->stockModel->stockDetail($id);
        return view('kasir/body/stock-product/edit-stock', $data);
    }
