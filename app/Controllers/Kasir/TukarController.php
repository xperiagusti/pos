...
class TukarController extends BaseController
{
    ...
    public function tukar()
    {
        ...
        return view('kasir/body/sale/index-tukar', $data);
    }
    ...
    public function saveData()
    {
        ...
        else
        {
            ...
            return redirect()->to('sibabad2/tukar');
        }
    ...
    public function cetakTransaksi($invoice)
    {
        ...
        return view('kasir/body/sale/cetak-termal-tukar', ['transaksi' => $transaksi1, 'tukar' => $transaksi2]);
    }
