...
class RefundController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('kasir/body/refund/index-shift', $data);
    }
    ...
    public function refund()
    {
        ...
        return view('kasir/body/sale/index-refund', $data);
    }
    ...
    public function saveData()
    {
        ...
        else
        {
            ...
            return redirect()->to('sibabad2/refund2');
        }
    ...
    public function cetakTransaksi($invoice)
    {
        ...
        return view('kasir/body/sale/cetak-termal-refund', ['transaksi' => $transaksi1, 'refund' => $transaksi2]);
    }
