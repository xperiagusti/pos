$(function () {
    ...
    function detailKeranjang() {
      let keranjang = ''
      $.ajax({
        url: `${BASE_URL}/admin/SaleController/keranjang`,
        dataType: 'json',
    ...
    $('#barcode').autocomplete({
      source: `${BASE_URL}/admin/StockProductController/barcode`,
      autoFocus: true,
      select: function (e, ui) {
        $.ajax({
          url: `${BASE_URL}/admin/StockProductController/detail`,
          type: 'get',
          data: {
          ...
          success: function (response) {
            ...
            $('#tampil-stok').text(`Stok Produk ${response.harga}`)
            if (response.stok == 0) {
